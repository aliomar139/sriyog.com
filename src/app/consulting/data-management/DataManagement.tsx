...
export default function Management() {
  ...
  return (
    <>
      <Ribbon name="Data Management" des="" />
      <section className="max-w-[1180px] mx-auto mb-[45px]  px-6 lg:px-0 ">
        <Image
          src="/consultingPage/database-management.jpg"
          width={1140}
          height={597}
          alt="top_image"
        ...
        <div className="max-w-[1180px] mx-auto text-[15px] text-justify leading-[23px] flex flex-col gap-4">
          <p>
            ...
            disaster recovery planning. Whether you&apos;re building a new
            system or improving an existing one, our database services are
            designed to support data integrity, performance, and security. With
            a proactive approach to database management, we help reduce
            downtime, prevent data loss, and enhance system responsiveness —
            enabling your business to operate smoothly and respond to data
