...
export default function Marketing() {
  ...
  useEffect(() => {
    const filtered = relatedConsulting.filter(
      (item) => item.main === "Digital Marketing"
    );
    setData(filtered);
  }, []);
  // const services = [
    ...
    <>
      ...
      <section className="max-w-[1180px] mx-auto mb-[45px]  px-6 lg:px-0 ">
        ...
        <p className="text-center text-[16px] mb-[45px]">
          From SEO and pay-per-click campaigns to social media marketing,
          content creation, and influencer collaborations, we offer a full suite
          of digital tools.
        </p>
        ...
        <div className="max-w-[1180px] mx-auto text-[15px] text-justify leading-[23px] flex flex-col gap-4">
          <p>
            Our digital marketing services are designed to help your brand stand
            out in a crowded online marketplace. We take a data-driven approach
            to create marketing strategies that increase your visibility, drive
            engagement, and boost conversions. From SEO and pay-per-click
            campaigns to social media marketing, content creation, and
            influencer collaborations, we offer a full suite of digital tools to
            support your goals. Our team works closely with you to understand
            your business, target audience, and objectives, crafting customized
            campaigns that deliver measurable results. We leverage the latest
            analytics tools to track performance and continuously optimize for
            higher ROI.{" "}
          </p>

          <p>
            Whether you&apos;re launching a new product, expanding into new
            markets, or simply looking to grow your online presence, our digital
            marketing experts have the skills and experience to help you
            succeed. With our support, your brand reaches the right people at
      ...
      <section className="max-w-[1180px] mx-auto mb-[45px] px-6 lg:px-0">
        ...
        <p className="text-center text-sm text-gray-800 mb-8">
          Here are some of the Digital Marketing frequently asked questions
        </p>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
            ...
            {[
              {
                ...
                answer:
                  "We offer SEO, pay-per-click campaigns, social media marketing, content creation, and influencer collaborations.",
              },
              {
                question: "How do you approach digital marketing strategies?",
                answer:
                  "We use a data-driven approach to increase visibility, drive engagement, and boost conversions.",
              },
              {
                question: "How do you customize campaigns for businesses?",
                answer:
                  "We work closely with you to understand your business, target audience, and objectives, crafting customized campaigns.",
              },
            ].map((faq, i) => (
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-8">
            {[
              {
                question: "How do you measure the performance of campaigns?",
                answer:
                  "We leverage the latest analytics tools to track performance and continuously optimize for higher ROI.",
              },
              {
                question:
                  "What kind of results can businesses expect from your digital marketing?",
                answer:
                  "Businesses can expect increased online presence, product launches, market expansion, and overall brand growth.",
              },
              {
                question: "What types of businesses do you serve?",
                answer:
                  "Our services are designed to help any brand stand out in a crowded online marketplace, whether they are launching new products or growing online presence.",
              },
              {
                question: "How do your services help brands succeed?",
                answer:
                  "Our experts help your brand reach the right people at the right time with the right message, ensuring success in the digital landscape.",
              },
            ].map((faq, i) => (
              <div key={i} className="relative flex items-start gap-5 group">
                <div className="w-10 h-10 flex items-center justify-center bg-[#055D59] text-white font-bold rounded-full mt-1 shrink-0">
