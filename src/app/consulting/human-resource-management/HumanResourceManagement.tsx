...
export default function ResourceManagement() {
  ...
  useEffect(() => {
    const filtered = relatedConsulting.filter(
      (item) => item.main === "Human Resource Management"
    );
    setData(filtered);
  }, []);
  const consulting = [
  ...
  return (
    <>
      <Ribbon name="Human Resource Management" des="" />
      <section className="max-w-[1180px] mx-auto mb-[45px]  px-6 lg:px-0 ">
        <Image
          src="/consultingPage/human-resource-management.jpg"
          width={1140}
          height={597}
          alt="top_image"
        ...
        <p className="text-center text-[16px] mb-[45px]">
          We use modern HR tools and best practices to streamline hiring
          processes, enhance employee engagement, and ensure regulatory
          compliance.
        </p>
        ...
        <div className="max-w-[1180px] mx-auto text-[15px] text-justify leading-[23px] flex flex-col gap-4">
          <p>
            We offer comprehensive human resource management services that
            empower organizations to effectively manage their workforce and
            foster a productive work environment. Our solutions cover the entire
            employee lifecycle, including recruitment, onboarding, performance
            management, payroll coordination, and compliance support. We use
            modern HR tools and best practices to streamline hiring processes,
            enhance employee engagement, and ensure regulatory compliance.{" "}
          </p>

          <p>
            Our recruitment strategies attract top talent, while our onboarding
            systems make the integration process smooth and efficient. We also
            provide tools and strategies for performance evaluations, employee
            feedback, and development planning to help organizations retain and
            grow talent. Whether you&apos;re a small business looking to
            formalize HR practices or a large enterprise seeking process
            optimization, our services are customized to fit your unique needs.
            We help organizations build a strong HR foundation that supports
            long-term growth and employee satisfaction.{" "}
          </p>
        </div>
      </section>
      ...
      <section className="max-w-[1180px] mx-auto mb-[45px] px-6 lg:px-0">
        ...
        <p className="text-center text-sm text-gray-800 mb-8">
          Here are some of the Human Resource Management frequently asked
          questions
        </p>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-8">
            {[
              ...
              {
                question:
                  "What kind of expertise do your IT consultants offer?",
                answer:
                  "We specialize in selecting and deploying enterprise software, integrating systems, and optimizing IT operations for maximum efficiency.",
              },
            ].map((faq, i) => (
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-8">
            {[
              ...
              {
                question:
                  "How do your IT consultancy services benefit businesses?",
                answer:
                  "Our services improve efficiency, reduce costs, support scalability, and help you leverage technology as a strategic asset.",
              },
              {
                question:
                  "Do you handle both short-term projects and long-term partnerships?",
                answer:
                  "Yes, we deliver results aligned with your business goals for both short-term projects and long-term partnerships.",
              },
              {
                question:
                  "Can you help with modernizing existing IT environments?",
                answer:
                  "Absolutely, whether you're modernizing your IT infrastructure or planning a full-scale overhaul, our consultancy services can assist you.",
              },
            ].map((faq, i) => (
              <div key={i} className="relative flex items-start gap-5 group">
                <div className="w-10 h-10 flex items-center justify-center bg-[#055D59] text-white font-bold rounded-full mt-1 shrink-0">
