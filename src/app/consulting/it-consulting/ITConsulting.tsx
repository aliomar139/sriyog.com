  ...
  return (
    <>
      ...
      <section className="max-w-[1180px] mx-auto mb-[45px]  px-6 lg:px-0 ">
        <Image
          src="/consultingPage/it-consultancy-management.jpg"
          width={1140}
          height={597}
          alt="top_image"
        ...
        <p className="text-center text-[16px] mb-[45px]">
          ...
          solutions that enhance efficiency, reduce costs, and support
          scalability.
        </p>
        ...
        <div className="max-w-[1180px] mx-auto text-[15px] text-justify leading-[23px] flex flex-col gap-4">
          <p>
            Our IT consultancy management services help businesses navigate
            complex technology challenges with confidence. We provide strategic
            guidance and hands-on support across a wide range of IT needs,
            including infrastructure design, system implementation,
            cybersecurity, cloud migration, and digital transformation. Our
            consultants work closely with your internal teams to understand your
            objectives and create tailored solutions that enhance efficiency,
            reduce costs, and support scalability.{" "}
          </p>

          <p>
            We bring expertise in selecting and deploying enterprise software,
            integrating systems, and optimizing IT operations. From short-term
            projects to long-term partnerships, we deliver results that align
            with your business goals and technical requirements. We also offer
            post-implementation support and training to ensure smooth
            transitions and maximum ROI. Whether you&apos;re modernizing your IT
            environment or planning a full-scale system overhaul, our
            consultancy services help you leverage technology as a strategic
      ...
      <section className="max-w-[1180px] mx-auto mb-[45px] px-6 lg:px-0">
        ...
        <p className="text-center text-sm text-gray-800 mb-8">
          Here are some of the IT Consulting frequently asked questions
        </p>
